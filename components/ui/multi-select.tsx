    ...
    <div className={cn("w-full", className)}>
      <Select
        ...
        classNames={{
          ...
          multiValue: () => cn(
            "flex items-center gap-1 rounded-md bg-secondary px-2 py-0.5 my-0.5",
            "dark:bg-secondary/80"
          ),
          multiValueLabel: () => "text-sm text-secondary-foreground truncate max-w-[120px]",
          multiValueRemove: () => cn(
          ...
          menu: () => cn(
            "mt-2 overflow-hidden rounded-md border border-input bg-popover text-popover-foreground shadow-md z-50 absolute w-full",
            "dark:bg-popover/80"
          ),
